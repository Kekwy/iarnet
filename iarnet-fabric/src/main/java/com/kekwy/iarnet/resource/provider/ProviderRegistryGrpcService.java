package com.kekwy.iarnet.resource.provider;
 ...
 */
@Component
public class ProviderRegistryGrpcService
        extends ProviderRegistryServiceGrpc.ProviderRegistryServiceImplBase {

    private static final Logger log = LoggerFactory.getLogger(ProviderRegistryGrpcService.class);
    ...
    public ProviderRegistryGrpcService(ProviderRegistry providerRegistry,
