...
| 3 | `combine("merge-cameras", ...)` | — | 多路视频流汇合 |
...
| 7 | `combine("merge-events", ...)` | — | 行人/车辆事件汇合 |
...
- **combine(name, other, function)**：多路汇合（摄像头流、事件流）
