 ...
 * 工作流函数类型定义。
 * <p>
 * 本包定义了 DSL 中各节点所对应的函数接口：任务（{@link com.kekwy.iarnet.sdk.function.TaskFunction}）、
 * 输出（{@link com.kekwy.iarnet.sdk.function.OutputFunction}）、
 * 条件分支（{@link com.kekwy.iarnet.sdk.function.ConditionFunction}）、
 * 多路合并（{@link com.kekwy.iarnet.sdk.function.CombineFunction}）。
 ...
 * @see com.kekwy.iarnet.sdk.function.CombineFunction
 */
