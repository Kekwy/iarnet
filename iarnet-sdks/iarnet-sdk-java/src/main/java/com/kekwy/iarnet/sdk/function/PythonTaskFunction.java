 ...
 * Python 实现的任务函数描述符。
 * <p>
 * 在 DSL 构建阶段仅描述“调用哪个 Python 函数、输出类型”，
...
public class PythonTaskFunction<I, O> implements TaskFunction<I, O> {
     ...
     */
    public PythonTaskFunction(String functionIdentifier) {
     ...
     */
    public PythonTaskFunction(String functionIdentifier, Type outputTypeHint) {
